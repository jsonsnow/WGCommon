#
# Be sure to run `pod lib lint WGCommon.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'WGCommon'
  s.version          = '0.1.1'
  s.summary          = 'A short description of WGCommon.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/jsonsnow/WGCommon'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jsonsnow' => '1183010734@qq.com' }
  s.source           = { :git => 'https://github.com/jsonsnow/WGCommon.git', :tag => s.version.to_s }
